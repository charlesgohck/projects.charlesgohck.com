        ...
        <div className="shadow-md rounded-lg mt-[200px] bg-white max-w-[340px] max-h-[428px] mx-auto pt-6 pb-6 pl-4 pr-4">
          ...
          <div>
            ...
            <div style={{ display: "flex", justifyContent: "center" }} className='mt-6'>
              <button className='grid place-items-center box-border w-9 h-9 ml-4 mr-4 p-1 hover:bg-zinc-50 hover:rounded-md focus:rounded-md focus:bg-zinc-50 focus:border-4 focus:border-indigo-100'>
